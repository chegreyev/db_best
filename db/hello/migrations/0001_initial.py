# Generated by Django 3.0 on 2019-12-06 21:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='universities', to='hello.City')),
            ],
        ),
        migrations.CreateModel(
            name='Profession',
            fields=[
                ...
                ('university_professions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='professions', to='hello.University')),
            ],
        ),
    ]
